...
<div>
  ...
  <div className="fixed bottom-14 right-2 z-50">
    <button
      ...
      className="
        ...
        bg-gradient-to-br from-blue-600/50 to-purple-700/40
        backdrop-blur-2xl
        border border-white/30
        shadow-[0_0_20px_5px_rgba(120,60,255,0.6)]
        overflow-hidden
        transition-all duration-500
        hover:scale-[1.1]
        hover:shadow-[0_0_15px_5px_rgba(150,80,255,0.9)]
        active:scale-95
        group
      "
    >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        fill="white"
        className="drop-shadow-[0_0_10px_white] group-hover:scale-110 transition-all duration-300"
      >
  ...
  {/* Tombol Musik — kiri bawah */}
  <div className="fixed bottom-14 left-0 z-50">
    <button
      onClick={() => setIsPlaying(!isPlaying)}
      className="w-10 h-10 bg-black rounded-full flex justify-center items-center shadow-lg hover:scale-110 active:scale-95 transition-all"
    >
        <svg
